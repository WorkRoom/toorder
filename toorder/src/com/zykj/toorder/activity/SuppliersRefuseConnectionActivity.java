...
public class SuppliersRefuseConnectionActivity extends BaseActivity implements
	...
	private void initView() {
		...
		suppIntradeAdapter = new CommonAdapter<Supplier>(
				SuppliersRefuseConnectionActivity.this,
				R.layout.ui_item_suppliers_message, getTestData()) {

			@Override
			public void convert(ViewHolder holder, Supplier supplier) {
				holder.setText(R.id.supplier_mess_title,StringUtil.toString(supplier.getName()))
				.setText(R.id.supplier_mess_content,StringUtil.toString(supplier.getIntro()));
			}
		};
		mListView.setAdapter(suppIntradeAdapter);
		mListView.setOnItemClickListener(SuppliersRefuseConnectionActivity.this);
